...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionImageView = (ImageView) findViewById(R.id.iv_main_question_image);
        questionTextView = (TextView) findViewById(R.id.tv_main_question_title);
        questionsRemainingTextView = (TextView) findViewById(R.id.tv_main_questions_remaining);
        answer0Button = (Button) findViewById(R.id.btn_main_answer_0);
        answer1Button = (Button) findViewById(R.id.btn_main_answer_1);
        answer2Button = (Button) findViewById(R.id.btn_main_answer_2);
        answer3Button = (Button) findViewById(R.id.btn_main_answer_3);
        submitButton = (Button) findViewById(R.id.btn_main_submit_answer);
    ...
    void displayQuestionsRemaining(int questionsRemaining){
        questionsRemainingTextView.setText(String.valueOf(questionsRemaining) + " questions remaining.");
    }
    ...
    void onAnswerSelected(int answerSelected){
        ...
        //reset button text in case other button was selected before
        answer0Button.setText(currentQuestion.answer0);
        answer1Button.setText(currentQuestion.answer1);
        answer2Button.setText(currentQuestion.answer2);
        answer3Button.setText(currentQuestion.answer3);

        //add check mark to button chosen text to indicate players choice
    ...
    void onAnswerSubmission() {
        ...
        //code will not execute if the player has not made a selection
    ...
    void startNewGame() {
        ...
        Question question8 = new Question(R.drawable.img_quote_8, "This mayor won’t get my vote — but did he actually give this piece of advice? And if not, who did?", "Forrest Gump, Forest Gump", "Dorry, Finding Nemo", "Esther Williams", "The Mayor, Jaws", 1);
        ...
        //set array of questions to be used in this round
